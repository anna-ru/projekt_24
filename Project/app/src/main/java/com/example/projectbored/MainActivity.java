...
import static com.example.projectbored.database.AppDatabase.DATABASE_NAME;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppDatabase db = Room.databaseBuilder(getApplicationContext(),
                AppDatabase.class, DATABASE_NAME).createFromAsset("database/events.csv").build();

        Log.e("EVENT LIST", db.eventDao().getAll().toString());
